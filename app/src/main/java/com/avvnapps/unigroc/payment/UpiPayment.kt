package com.avvnapps.unigroc.payment
...
import com.avvnapps.unigroc.payment.ui.UpiBottomSheet
...
class UpiPayment(activity: FragmentActivity) {
    ...
    companion object {
        ...
        val UPI_APPS: ArrayList<String> =
            arrayListOf("google pay", "phonepe", "paytm", "bhim", "mobikwik")
    ...
    fun pay() {
        if (mOnUpiPaymentListener != null)
            ...
            Toast.makeText(mActivity.get(), "set callback listener first.", Toast.LENGTH_SHORT)
                .show()
    }
    ...
    private fun startFragment() {
        if (!hasError()) {
            ...
            mActivity.get()?.supportFragmentManager?.beginTransaction()
                ?.add(fragment, UpiPaymentFragment::class.java.name)?.commitAllowingStateLoss()
        }
    }
...
//        }
    ...
    class UpiPaymentFragment : Fragment(), AnkoLogger {
        ...
        override fun onActivityCreated(savedInstanceState: Bundle?) {
            ...
            val paymentDetail =
                arguments?.getSerializable(PaymentDetail.ARG_BUNDLE) as PaymentDetail
        ...
        private fun startUpiBottomSheet(uri: Uri) {
            ...
            bundle.putStringArrayList(
                ARG_UPI_APPS_LIST,
                arguments?.getStringArrayList(ARG_UPI_APPS_LIST)
            )
            ...
            upiBottomSheet.show(
                ...
                , UpiBottomSheet::class.java.simpleName
            )
        }
