package com.avvnapps.unigroc.payment.adapter
...
class UpiListAdapter : RecyclerView.Adapter<UpiListAdapter.AppViewHolder>() {
    ...
    fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AppViewHolder {
        ...
        val layout =
            LayoutInflater.from(mContext).inflate(R.layout.upi_payment_item_upi_list, parent, false)
    ...
    inner class AppViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(info: ResolveInfo) {
            itemView.item_upi_list_txt_name.text =
